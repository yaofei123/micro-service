 ...
 */
package com.ehaoyao.ucenter.framework.base.service;


import com.ehaoyao.ucenter.framework.base.dao.BaseDao;
import com.ehaoyao.ucenter.framework.exception.ExceptionConstants;
...
public abstract class BaseService<T> {
    ...
    public PageResponse<T> pageList(T params, Pagination pagination) {
        ...
        List<T> result = baseDao.listPage(params, pagination);
        PageResponse<T> response = new PageResponse<>();
