...
<script src="${ctxStatic}/jquery-serializeJson/jquery.serializejson.js" type="text/javascript"></script>
<link href="${ctxStatic}/common/jeesite.css" type="text/css" rel="stylesheet" />
<script src="${ctxStatic}/common/jeesite.js" type="text/javascript"></script>
<script src="${ctxStatic}/area/commonarea.js" type="text/javascript"></script>
